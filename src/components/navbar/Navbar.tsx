...
export default function Navbar() {
    ...
    const forceWhite = pathname === "/contact" || pathname === "/privacy-policy" || pathname === "/terms-of-service" || pathname === "/cookie-policy" || pathname === "/advertising-partners" || pathname === "/do-not-sell" || pathname === "/privacy-summary" || pathname?.startsWith("/privacy/");
